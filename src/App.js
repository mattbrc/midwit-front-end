...
export default function App() {
	...
	const mintNFT = async () => {
		...
		if (ethereum) {
			...
			let tx = await contract.register(score, {value: ethers.utils.parseEther(price)});
		...
		<div>
			<div className="connect-wallet-container">
				...
				<div className='button-container'>
					<button className="cta-button mint-button connect-wallet" onClick={connectWallet}><img className="polygon-logo" alt='polygon' src={polygonLogo}/>
					Connect Wallet
					</button>
				</div>
			</div>
